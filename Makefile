...
SOURCES_FILES =			so_long.c map_verification.c render_elements.c controls.c \
						player_control.c inspect.c
...
SOURCES_FILES_BONUS =	so_long_bonus.c map_verification_bonus.c \
						render_elements_bonus.c controls_bonus.c \
						player_control_bonus.c init_images_bonus.c \
						inspect_bonus.c enemy_movement_bonus.c \
						moves_counter_bonus.c kill_figure_bonus.c
...
run:					bonus
						./so_long_bonus maps/rick_world.ber
